...
def acos(x):
    if np.iterable(x):
        return [math.acos(val.convert_to(radians).get_value()) for val in x]
    else:
        return math.acos(x.convert_to(radians).get_value())

def asin(x):
    if np.iterable(x):
        return [math.asin(val.convert_to(radians).get_value()) for val in x]
    else:
        return math.asin(x.convert_to(radians).get_value())

def atan(x):
    if np.iterable(x):
        return [math.atan(val.convert_to(radians).get_value()) for val in x]
    else:
        return math.atan(x.convert_to(radians).get_value())"""
