...
#----------------------calculamos las n derivadas trigonometricas que ingrese el usuario--------------------#
...
def intervalo_de_cre(k,q,w,a,b):
	...
	if k ==[]:
		...
		while i < len(inter_cre)-1:
			...
			result=all(e<0 for e in crece_decrece)
			if result:
